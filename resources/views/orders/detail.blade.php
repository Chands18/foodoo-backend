<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            Order In Progress &raquo; {{ $item->food->name }} by {{ $item->user->name }}
        </h2>
    </x-slot>
